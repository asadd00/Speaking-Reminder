...
public class MyAudioRecorder
{
     ...
     *
     */
    public MyAudioRecorder(boolean uncompressed, int audioSource, int sampleRate, int channelConfig,
                           int audioFormat)
    {
        try
        {
            ...
            { // RECORDING_UNCOMPRESSED
                ...
                { // Check to make sure buffer size is not smaller than the smallest allowed one
                    ...
                    Log.w(MyAudioRecorder.class.getName(), "Increasing buffer size to " + Integer.toString(bufferSize));
                }
